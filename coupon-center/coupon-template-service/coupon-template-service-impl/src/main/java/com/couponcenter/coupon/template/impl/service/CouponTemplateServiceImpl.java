package com.couponcenter.coupon.template.impl.service;
...
import com.couponcenter.coupon.template.api.beans.rules.Discount;
import com.couponcenter.coupon.template.api.enums.CouponType;
import com.couponcenter.coupon.template.dao.CouponTemplateDao;
import com.couponcenter.coupon.template.dao.entity.CouponTemplate;
import com.couponcenter.coupon.template.impl.converter.CouponTemplateConverter;
...
//        templateDao.findAll(Example.of(example), page);
        List<com.couponcenter.coupon.template.dao.entity.CouponTemplate> result = templateDao.findAll(Example.of(example));
